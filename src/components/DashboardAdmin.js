    ...
    <div className="modal-overlay">
        ...
        <li>No users found.</li>
            ...
            <div className="section">
                ...
                <button className="handclearleader" onClick >Clear Progress</button>
                <table>
                    <thead>
                        <tr>
                            <th>Rank</th>
            ...
            <div className="section">
                ...
                <div className="questions-section">
                    ...
                    <button className="handleaddquestion" onClick={handleAddQuestion}>Add Question</button>
                </div>
                <button className="handleaddquiz" onClick={handleAddQuiz}>Add Quiz</button>
                <ul>
                    {quizzes.map(quiz => (
                        <li key={quiz.id}>
                            {quiz.title}
                            <button className="handledeletequiz" onClick={() => handleDeleteQuiz(quiz.id)}>Delete</button>
                        </li>
                    ))}
                </ul>
            </div>
